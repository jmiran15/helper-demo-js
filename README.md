...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create helper-bdf0
  fly apps create helper-bdf0-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app helper-bdf0
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app helper-bdf0-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'helper-bdf0-staging' does not match app name in config file 'helper-bdf0'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name helper-bdf0-db
  fly postgres attach --app helper-bdf0 helper-bdf0-db

  fly postgres create --name helper-bdf0-staging-db
  fly postgres attach --app helper-bdf0-staging helper-bdf0-staging-db
  ```
